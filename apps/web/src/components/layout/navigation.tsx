    ...
    <nav className="hidden md:block">
      <div className="sticky top-5 flex min-h-[calc(100vh-2.5rem)] flex-col rounded-[20px] border border-border bg-[var(--sidebar)] px-3 py-4 shadow-[var(--shadow-sidebar)]">
        <div className="mb-2 flex items-center gap-3 px-2 py-3">
          ...
          <div>
            <p className="text-[1.15rem] font-bold leading-tight tracking-[-0.04em]">TikTo</p>
            <p className="text-[11px] text-[var(--sidebar-muted)]">Tasks + Calendar</p>
          </div>
        </div>
        ...
        <div className="mt-auto px-3 pt-6">
          <p className="text-[11px] leading-5 text-[var(--sidebar-muted)]">
            Plan your day with focused services.
          </p>
        </div>
      </div>
    </nav>
